    ...
    public partial class _Default : System.Web.UI.Page
    {
        ...
        public static string GetData()
        {
            ...
            foreach (var serie in data.Series)
            {
                ...
                HttpContext.Current.Session["xAxisMinValueS"] = xAxisMinValue;
                data.ChartConfig.yAxisMinValue = yAxisMinValue;
                HttpContext.Current.Session["yAxisMinValueS"] = yAxisMinValue;
                data.ChartConfig.zAxisMinValue = zAxisMinValue;
                HttpContext.Current.Session["zAxisMinValueS"] = zAxisMinValue;

                data.ChartConfig.xAxisMaxValue = xAxisMaxValue;
                HttpContext.Current.Session["xAxisMaxValueS"] = xAxisMaxValue;
                data.ChartConfig.yAxisMaxValue = yAxisMaxValue;
                HttpContext.Current.Session["yAxisMaxValueS"] = yAxisMaxValue;
                data.ChartConfig.zAxisMaxValue = zAxisMaxValue;
                HttpContext.Current.Session["zAxisMaxValueS"] = zAxisMaxValue;

            }
            #endregion

            HttpContext.Current.Session["Result"] = data.Series[0].Points;
